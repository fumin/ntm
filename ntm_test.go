...
func TestRMSProp(t *testing.T) {
	...
	c.WeightsVal()[c.NumWeights()-1] = 0.9
	c.WeightsGrad()[c.NumWeights()-1] = 1.3
	rms.N[c.NumWeights()-1] = 12.3
	rms.G[c.NumWeights()-1] = 0.8
	rms.D[c.NumWeights()-1] = 8.1
	...
	checkRMS(t, c, rms, c.NumWeights()-1, 11.7695, 0.825, 7.289961, 8.189961)
}
